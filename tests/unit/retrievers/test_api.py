...
from app.retrievers.twitter.api import get_api, get_auth_handler


@patch('app.retrievers.twitter.api.get_auth_handler')
@patch('app.retrievers.twitter.api.tweepy')
